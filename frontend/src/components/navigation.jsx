...
export const Navigation = () => {
    ...
    // Lắng nghe login/logout/cart update
    useEffect(() => {
        ...
        window.addEventListener("loginSuccess", handleLoginOrCartUpdate);
        window.addEventListener("logout", handleLoginOrCartUpdate);
        window.addEventListener("cartUpdated", handleLoginOrCartUpdate);
        window.addEventListener("storage", handleLoginOrCartUpdate); // cho các tab khác
    ...
    //                             <Link to="/login" className="nav-link fw-semibold text-primary">
    //                                 Đăng nhập
    //                             </Link>
    //                         </li>
    //                     ) : (
    ...
    //                             {/*        <li>*/}
    //                             {/*            <Link className="dropdown-item" to="/account-settings">Quản lý tài khoản</Link>*/}
    //                             {/*        </li>*/}
    //                             {/*        <li>*/}
    //                             {/*            <Link className="dropdown-item" to="/my-courses">Khóa học của tôi</Link> /!* Thêm dòng này *!/*/}
    //                             {/*        </li>*/}
    //                             {/*        <li>*/}
    //                             {/*            <Link className="dropdown-item" to="/order-history">Lịch sử mua hàng</Link>*/}
    //                             {/*        </li>*/}
    //                             {/*        <li>*/}
    ...
    //                                     <span className="text-dark fw-medium">Hey, {userName}</span>
    //                                 </a>
    //                                 <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
    //                                     <li>
    //                                         <Link className="dropdown-item" to="/account-settings">Quản lý tài khoản</Link>
    //                                     </li>
    //                                     <li>
    //                                         <Link className="dropdown-item" to="/my-courses">Khóa học của tôi</Link>
    //                                     </li>
    //                                     <li>
    //                                         <Link className="dropdown-item" to="/order-history">Lịch sử mua hàng</Link>
    //                                     </li>
    ...
    //                                 >
    //                                     <FaUserCircle className="me-2"/>
    //                                     <span className="text-primary fw-medium">Hey, {userName}</span>
    //                                 </a>
    //
    ...
    //                                     <div className="row">
    //                                         <div className="col-6">
    //                                             <Link to="/my-courses" className="dropdown-item px-0 py-1">Khóa học của tôi</Link>
    //                                             <Link to="/order-history" className="dropdown-item px-0 py-1">Lịch sử mua hàng</Link>
    //                                         </div>
    //                                         <div className="col-6">
    //                                             <Link to="/quizzes" className="dropdown-item px-0 py-1">Làm Quiz</Link>
    //                                             <Link to="/assignments" className="dropdown-item px-0 py-1">Bài tập</Link>
    //                                         </div>
    //                                     </div>
    //                                     <hr className="my-3"/>
    //                                     <div className="d-flex justify-content-end">
    //                                         <button onClick={handleLogout}
    //                                                 className="btn btn-link text-danger p-0">Logout
    //                                         </button>
    //                                     </div>
    //                                 </div>
    //                             </li>
