...
const CheckoutPage = () => {
    ...
    useEffect(() => {
        const initRowCount = async () => {
            try {
                ...
                // const response = await fetch("https://script.google.com/macros/s/" +
                //     "AKfycbxQwEp5EnI-RclcaPwcVJsSxT4zsJDHmkSKusPMAUyN2Uk9E8y-DSRR_ey8aMwhwVKyYw/exec");
    ...
    useEffect(() => {
        const fetchLastId = async () => {
            try {
                ...
                // console.error("Lỗi khi lấy lastId:", err);
            }
        };
    ...
    const handleCancelPayment = () => {
        Swal.fire({
            ...
            text: "Press OK to cancel.",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonText: 'Cancel confirm',
            cancelButtonText: 'Continue making payment'
        }).then((result) => {
                ...
                <div className="row">
                                ...
                                <div className="d-flex align-items-center border-bottom py-3" key={item.id}>
                                    ...
                                    <div className="text-end">
                                        {finalPrice < originalPrice ? (
                                            ...
                                            <div className="fs-5">{finalPrice.toLocaleString()} VND</div>
                                        )}
                                    </div>
                                </div>
                            );
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="mt-4 text-center">
                            ...
                            <img
                                src={`https://img.vietqr.io/image/mbbank-0969064150-compact2.jpg?amount=${totalPrice / 100}&addInfo=ORDER_${lastIdRef.current}&accountName=To%20Quoc%20Tung`}
                                alt="QR Thanh toán"
                                style={{ width: 300 }}
                            />
                        </div>
