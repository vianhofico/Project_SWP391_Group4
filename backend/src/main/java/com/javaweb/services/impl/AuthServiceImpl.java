...
//import com.javaweb.service.MailService;
...
//    private final MailService mailService;
    ...
    public LoginResponse login(LoginRequest loginRequest) {
        try {
            ...
            User thisUser = userRepository.findByEmail(loginRequest.email());
...
//        }
//        Optional<User> existingUser = userRepository.findByEmailOpt(email);
