                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1 items-center'>
                    <div className='col-span-6 flex flex-col gap-8 '>
                        <div className='flex gap-2 mx-auto lg:mx-0'>
                            ...
                            />
                            <p className='text-success text-sm font-semibold text-center lg:text-start'>Giảm 30% với khóa học đầu tiên</p>
                        </div>
                        <h1 className='text-midnight_text text-4xl sm:text-5xl font-semibold pt-5 lg:pt-0'>Cải thiện kĩ năng lập trình của bạn ngay hôm nay.</h1>
